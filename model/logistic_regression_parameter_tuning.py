...
def logistic_reg_hyperparameter(X,y):
	# Returns the parameters that obtains the best result for logistic regression
...
def main():
	...
	y_val,y_pred,best_model,X_val = logistic_reg_hyperparameter(X,y)
